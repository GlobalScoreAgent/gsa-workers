#!/usr/bin/env python3
"""Daily wallet balance and nonce batch job for erc_8004.wallets."""
...
async def run_job() -> int:
    ...
    concurrency = env_int("CONCURRENCY", default=20, minimum=1, maximum=20)
    claim_batch_size = env_int("CLAIM_BATCH_SIZE", default=200, minimum=1)
    ...
    try:
        async with httpx.AsyncClient(timeout=10.0, limits=http_limits) as http_client:
            while True:
