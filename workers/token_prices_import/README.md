...
Cron `0 0,6,12,18 * * *` UTC + `workflow_dispatch` (same cadence as claim/discovery workers; soft stop at `MAX_RUNTIME_SECONDS=19800`). Requires GitHub secret `COINGECKO_KEY`.
